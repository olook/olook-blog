...
if ($valid_image === true) {
	...
	$html .= "<tr><th>".__("Nome", "catablog")."</th>";
	$html .= "<td>";
	...
	if (!in_array('description', $hide_fields)) {
		$html .= "<tr><th>".__("Marca", "catablog")."</th>";
   ...
   $campos = array('link', 'preço', 'cod. produto', 'ordem');
	...
	$html .= "<tr><th>&nbsp;</th>";
	$html .= "<td>";
	$html .= "<input type='button' class='button-primary' name='submit' value='".__('Salvar', 'catablog')."' />";
