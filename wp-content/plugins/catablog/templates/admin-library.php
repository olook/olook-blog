		...
		<div class="tablenav">
			...
			<form id="catablog-bulk-action-form" method="post" action="admin.php?page=catablog-bulkedit" class="alignleft actions">
				...
				<select id="bulk-action" name="bulk-action">
					<option value="">- <?php _e("Escolha uma ação", 'catablog'); ?></option>
					<option value="add-to-gallery"><?php _e("Adicionar à Galeria", 'catablog'); ?></option>
					<option value="edit-category"><?php _e("Editar Categorias", 'catablog'); ?></option>
					<option value="regenerate-images"><?php _e("Regerar Imagens", 'catablog'); ?></option>
					<option value="delete"><?php _e("Deletar", 'catablog'); ?></option>
				</select>
				
				<input type="submit" value="<?php _e("Aplicar", 'catablog'); ?>" class="button-secondary" />
				<small>|</small>
			</form>
			...
			<form method="get" action="admin.php?page=catablog" class="alignleft actions">
				...
				<select id="cat" name="category" class="postform">
					<option value="-1">- <?php _e("Todas Categorias", 'catablog'); ?></option>
