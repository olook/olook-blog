...
class CataBlog {
	...
	*****************************************************/
	...
	public function admin_menu() {
		...
		add_submenu_page('catablog', __("CataBlog Library", 'catablog'), __('Produtos', 'catablog'), $this->user_level, 'catablog', array(&$this, 'admin_library'));
		add_submenu_page('catablog', __("Add New CataBlog Entry", 'catablog'), __('Adicionar Novo', 'catablog'), $this->user_level, 'catablog-upload', array(&$this, 'admin_new'));
		add_submenu_page('catablog', __("CataBlog Galleries", 'catablog'), __('Galerias de Produtos', 'catablog'), $this->user_level, 'catablog-gallery', array(&$this, 'admin_galleries'));
