...
function max_magazine_setup() {
   ...
   add_image_size( 'wt-home-tv', 650, 485, true );	         //for home tv / landing
	add_image_size( 'wt-recents-tips', 300, 223, true );	   //for recents tips posts widgets
...
if (!function_exists('wellthemes_js')) {
    ...
    function wellthemes_js() {
		...
		wp_enqueue_script('wt_header', get_template_directory_uri().'/js/functions.js',array('jquery'));
    }
