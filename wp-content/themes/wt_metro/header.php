  ...
  <nav class="menu_new">
    <div class="content_new">
      <ul class="default_new">
          <li class="showroom"><a href="/" class="home#index">Minha Vitrine</a></li><li class="lookbooks"><a href="/tendencias" class="lookbooks#index lookbooks#show">Tendências</a></li><li class="moments"><a href="/colecoes" class="moments#index">Coleções</a></li><li class="categories"><a href="/roupas" class="moments#clothes">Roupas</a></li><li class="categories"><a href="/sapatos" class="moments#show#1">Sapatos</a></li><li class="categories"><a href="/bolsas" class="moments#show#2">Bolsas</a></li><li class="categories"><a href="/acessorios" class="moments#show#3">Acessórios</a></li><li class="gift"><a href="/presentes" class="gift/home#index gift/occasions#new gift/occasions#new_with_data gift/survey#new gift/recipients#edit gift/suggestions#index">Presentes</a></li><li class="stylist"><a href="/stylists/helena-linhares" class="stylists#helena_linhares">Stylist</a></li>
        <li id='bar'>&nbsp;</li>
      </ul>
    </div>
  </nav>
