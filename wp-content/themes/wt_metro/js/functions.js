...
function addBanner(){
  if($("h3.comment-title").length > 0){
    $('<div class="banner"><a class="footer-banner-post" target="_blank" http://www.olook.com.br/colecoes/boho_chic"><img src="http://stylist-news.olook.com.br/wp-content/themes/wt_metro/images/gifs/banner_quiz_footer_post_SN.jpg" /></a>').insertBefore('.comment-title');
  }
}
