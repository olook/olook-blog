...
function addBanner(){
  if($("h3.comment-title").length > 0){
    $('<div class="banner"><a class="footer-banner-post" target="_blank" href="http://www.olook.com.br/colecoes/boho_chic"><img src="http://stylist-news.olook.com.br/wp-content/themes/wt_metro/images/gifs/banner_quiz_blog.jpg" /></a>').insertBefore('.comment-title');
  }
}
