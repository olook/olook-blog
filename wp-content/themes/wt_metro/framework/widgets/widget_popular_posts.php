  ...
  //       $args = array(
		...
		<div class="item-post <?php echo $class; ?>">		
			...
			<div class="post-right">
				<h4>
					<a href="<?php echo get_permalink($post); ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'wellthemes'), the_title_attribute('echo=0')); ?>">
						<?php 
							//display only first 50 characters in the title.	
							$short_title = mb_substr(/*the_title('','',FALSE)*/get_the_title($post,'', '', FALSE),0, 50);
							echo $short_title; 
						...
						<?php 
							//display only first 50 characters in the title.	
							$subtitle = mb_substr(/*the_title('','',FALSE)*/get_the_subtitle($post,'', '', FALSE),0, 50);
							echo $subtitle; 
